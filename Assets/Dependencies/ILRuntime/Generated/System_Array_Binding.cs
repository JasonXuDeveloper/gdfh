    ...
    unsafe class System_Array_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("Resize", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(void), typeof(global::MonoBehaviourAdapter.Adaptor[]).MakeByRefType(), typeof(System.Int32)))
                    {
                        method = m.MakeGenericMethod(args);
                        app.RegisterCLRMethodRedirection(method, Resize_0);
        ...
        static StackObject* Resize_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::MonoBehaviourAdapter.Adaptor[] @array = (global::MonoBehaviourAdapter.Adaptor[])typeof(global::MonoBehaviourAdapter.Adaptor[]).CheckCLRTypes(__intp.RetriveObject(ptr_of_this_method, __mStack), (CLR.Utils.Extensions.TypeFlags)0);


            System.Array.Resize<global::MonoBehaviourAdapter.Adaptor>(ref @array, @newSize);
