...
{
    unsafe class JEngine_Core_BindableProperty_1_Int32_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(JEngine.Core.BindableProperty<System.Int32>);
            args = new Type[]{};
            method = type.GetMethod("get_Value", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_Value_0);
            args = new Type[]{typeof(JEngine.Core.BindableProperty<System.Int32>)};
        ...
        static StackObject* get_Value_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            JEngine.Core.BindableProperty<System.Int32> instance_of_this_method = (JEngine.Core.BindableProperty<System.Int32>)typeof(JEngine.Core.BindableProperty<System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* op_Implicit_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ptr_of_this_method = ILIntepreter.Minus(__esp, 1);
            JEngine.Core.BindableProperty<System.Int32> @t = (JEngine.Core.BindableProperty<System.Int32>)typeof(JEngine.Core.BindableProperty<System.Int32>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);
        ...
        static StackObject* Ctor_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = new JEngine.Core.BindableProperty<System.Int32>(@val);
