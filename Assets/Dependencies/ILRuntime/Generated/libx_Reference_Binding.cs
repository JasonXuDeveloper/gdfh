...
namespace ILRuntime.Runtime.Generated
{
    unsafe class libx_Reference_Binding
    {
        ...
        static StackObject* Release_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            libx.Reference instance_of_this_method = (libx.Reference)typeof(libx.Reference).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
