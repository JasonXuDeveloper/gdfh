...
public static class ProcessHelper
    {
        ...
        {
            UnityEngine.Debug.Log($"Process Run exe:{exe} ,arguments:{arguments} ,workingDirectory:{workingDirectory}");
            try
            {
        ...
        private static async void WaitExitAsync(Process process)
        {
            ...
            UnityEngine.Debug.LogError($"process exit, exitcode: {process.ExitCode} {process.StandardOutput.ReadToEnd()} {process.StandardError.ReadToEnd()}");
        }
