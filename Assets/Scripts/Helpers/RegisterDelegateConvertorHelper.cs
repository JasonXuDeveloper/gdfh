...
namespace JEngine.Helper
{
    public class RegisterDelegateConvertorHelper
    {
        ...
        public void Register(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterDelegateConvertor<JEngine.Core.BindableProperty<System.Boolean>.onChange>((act) =>
            {
                return new JEngine.Core.BindableProperty<System.Boolean>.onChange((val) =>
                {
                    ((Action<System.Boolean>)act)(val);
                });
            });
            appdomain.DelegateManager.RegisterDelegateConvertor<LitJson.ImporterFunc<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>>((act) =>
            {
                return new LitJson.ImporterFunc<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>((input) =>
                {
