...
namespace JEngine.Helper
{
    public class RegisterLitJsonHelper : IRegisterHelper
    {
        ...
        public void Register(AppDomain appdomain)
        {
            ...
            JsonMapper.RegisterExporter<BigInteger>((obj, writer) => writer.Write(obj.ToString()));
            JsonMapper.RegisterImporter<string, BigInteger>(input => BigInteger.Parse(input));
            JsonMapper.RegisterImporter<double, BigInteger>(input => new BigInteger(input));
            JsonMapper.RegisterImporter<int, BigInteger>(input => new BigInteger(input));
            JsonMapper.RegisterImporter<uint, BigInteger>(input => new BigInteger(input));
            JsonMapper.RegisterImporter<long, BigInteger>(input => new BigInteger(input));
            JsonMapper.RegisterImporter<ulong, BigInteger>(input => new BigInteger(input));
            JsonMapper.RegisterImporter<float, BigInteger>(input => new BigInteger(input));
