...
namespace JEngine.Helper
{
    public class RegisterFunctionDelegateHelper : IRegisterHelper
    {
        ...
        public void Register(AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterFunctionDelegate<System.String, ILRuntime.Runtime.Intepreter.ILTypeInstance>();
            appdomain.DelegateManager.RegisterFunctionDelegate<ILRuntime.Runtime.Intepreter.ILTypeInstance, System.Int32>();
            appdomain.DelegateManager.RegisterFunctionDelegate<ILRuntime.Runtime.Intepreter.ILTypeInstance, System.Numerics.BigInteger>();
        }
    }
}